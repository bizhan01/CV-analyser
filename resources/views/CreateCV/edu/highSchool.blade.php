<p>Please Enter Your <strong style="color: blue">High School Secondary Education </strong> Details Here  </p>
  <input type="hidden" name="user_id[]" value="{{Auth::user()->id}}">
<div class="row form-group">
    <input type="hidden"  name="degree[]" value="High School Secondary Education">
   <div class="col-md-3 mb-3 mb-md-0">
     <label  for="Field of Study" style="color:black">Field of Study </label>
     <input type="text"  name="fieldOfStudy[]"  value="General Studies " class="form-control" placeholder="Field of Study">
   </div>
   <div class="col-md-3">
